...
from backend.api.v1.endpoints import experiments, training, environment, visualization, archives, intelligence, onnx
...
app.include_router(onnx.router, prefix="/api/v1/onnx", tags=["onnx"])
